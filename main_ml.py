...
def main_ml(model_1=False, model_2=False, model_3=False, model_4=False):
    """
    ...
    if not model_1 and not model_2 and not model_3 and not model_4:
    ...
    if model_4:
        main_xgboost(dataset_name, feature_name)
